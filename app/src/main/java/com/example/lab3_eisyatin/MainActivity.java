...
import com.example.lab3_eisyatin.databinding.ActivityMainBinding;
...
public class  MainActivity extends AppCompatActivity {
    ...
    DataHelper dbcenter;
    //to access clas create bio, update bio, view bio
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, CreateBiodataActivity.class); //transition from main page to create bio
